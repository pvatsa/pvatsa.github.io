...
Very similarly, in life and in business, when we solve one part of the problem (inventory, scheduling, accounting) with a technical solution, we mess up another (collaboration, social). Each platform offer a common solution for all business problems or they are a mish-mash of different solutions all cobbled together.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMjMzOTU5OTgyLC0xMzkxOTg3NTA1XX0=
-->