...
One of the key objectives of Rubixworks is to ensure that the platform can easily be supported by strong AI capabilities. Conversation Bots, Document recognition, Entity recognition, Speech-to-text and Text-to-Speech capabilities are being planned upfront. With all this in the plans, Rubixworks is targetted to be "The Intelligent Network" that enables transact
<!--stackedit_data:
eyJoaXN0b3J5IjpbMjExMDY0MjQ3MV19
-->