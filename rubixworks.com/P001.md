...
One of the key objectives of Rubixworks is to ensure that the platform can easily be supported by strong AI capabilities. Conversation Bots, Document recognition, Entity recognition, Speech-to-text and Text-to-Speech capabilities are being planned upfront. AI features on Rubixworks are meant to 'step-in' for one side of the 2-way transaction su

With all this in the plans, Rubixworks is targetted to be "The Intelligent Network" that enables a 2-phase transaction across entities.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTI5NzAyOTM0OCwtMTIxNDU1NjgzNywxMj
c0MzM3NjRdfQ==
-->