...
This is the the most active repo where we will pen down notes for all the different projects and domains that we are involved with. 
 ...
 5. [T05.ERP Cloud Collaboration](C01/T03/P000.Cover) - A platform that extends a SAGE ERP into the cloud and leverages  and video conferencing for real-time 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTEzMDgzMjUyMzEsLTIxMzMxNTQ1NDcsLT
QwMzE1NjUwNV19
-->